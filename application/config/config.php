...
|
*/
$config['base_url'] = 'http://localhost/product_project/';
/*
|--------------------------------------------------------------------------
| Index File
|--------------------------------------------------------------------------
...
/*
|--------------------------------------------------------------------------
| Migration runner key
|--------------------------------------------------------------------------
| A temporary key that allows running the migration runner without an
| admin session: visit /admin/migrate?key=YOUR_KEY
*/
$config['migration_key'] = 'changeme-migrate-2026';
